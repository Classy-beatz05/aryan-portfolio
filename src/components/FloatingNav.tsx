...
export function FloatingNav() {
  const socialLinks = [
    { icon: Github, href: 'https://github.com/Classy-beatz05', label: 'GitHub' },
    { icon: Linkedin, href: 'https://www.linkedin.com/in/aryan-zambare05/', label: 'LinkedIn' },
    ...
    { icon: Instagram, href: '#', label: 'Instagram' },
    {
      ...
      href: 'https://leetcode.com/u/Aryan_1207/',
      label: 'LeetCode'
    },
    { icon: Mail, href: 'mailto:aryanzambare05@gmail.com', label: 'Email' },
  ];
