...
export function Home({ theme }: HeroProps) {
  ...
  const connectLinks = [
    { img: linkedinLogo, link: "https://www.linkedin.com/in/aryan-zambare05/" },
    { img: gmailLogo, link: "mailto:aryanzambare05@gmail.com" },
    { img: whatsappLogo, link: "https://wa.me/+918975079094" },
    { img: instagramLogo, link: "https://www.instagram.com/" },
    { img: facebookLogo, link: "https://www.facebook.com/" },
  ];

  const workLinks = [
    { img: githubLogo, link: "https://github.com/Classy-beatz05" },
    { img: leetcodeLogo, link: "https://leetcode.com/u/Aryan_1207/" },
  ];

  const [typedRoles, setTypedRoles] = useState("");
  const rolesText = "Electronics & Telecommunication Engineer | Frontend Developer | Tech Explorer";
    ...
    <section id="home" className="hero">
      ...
      <motion.div className="hero-content" variants={containerVariants} initial="hidden" animate="visible">
        <motion.h1 className="hero-name" variants={itemVariants}>
          Hi! I’m <br />
          <span className="gradient-text hero-name-line">ARYAN ZAMBARE</span>
        ...
        <motion.div className="hero-info" variants={itemVariants}>
          {[
            { label: "📍 Location", value: "Punawale, Pune, India" },
            { label: "💼 Expertise", value: "Electronics & Telecommunication Engineering, Web Development" },
            { label: "📞 Contact", value: "aryanzambare05@gmail.com" },
          ].map((info, i) => (
