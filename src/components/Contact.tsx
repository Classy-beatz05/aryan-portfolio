...
export function Contact() {
  ...
  const contactInfo = [
    { icon: Mail, label: "Email", value: "aryanzambare05@gmail.com" },
    { icon: Phone, label: "Phone", value: "+91 8975079094" },
    { icon: MapPin, label: "Location", value: "Punawale, Pune, India" },
  ];

  const quickLinks = [
    { icon: Github, url: "https://github.com/Classy-beatz05" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/aryan-zambare05/" },
    { icon: Mail, url: "mailto:aryanzambare05@gmail.com" },
    { icon: MessageCircle, url: "https://wa.me/+918975079094" },
