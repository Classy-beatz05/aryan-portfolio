...
export function About() {
  ...
  const counters = [
    ...
    { icon: Cpu, label: "Hands-on Technologies ", value: 7 },
    { icon: Trophy, label: "HackerRank Solved", value: 50 },
  ];
        ...
        <div className="about-sticky">
          ...
          >
            <div className="info-inner">
              ...
              <p>
                I’m Aryan Zambare, a tech-driven Electronics & Telecommunication Engineering student passionate about building practical, real-world engineering solutions.
                I enjoy working across embedded systems, machine learning, and software development to solve meaningful problems.
                I’m motivated to continuously learn, innovate, and grow in a challenging professional environment.
              </p>

              <p>
                Beyond coding, I enjoy exploring hardware–software integration, experimenting with system design,
                and understanding how intelligent systems work end to end. I aim to build solutions that are not only functional,
                but also efficient, reliable, and impactful.
              </p>

              <p>
                Third-year Electronics & Computer Engineering student with hands-on experience in embedded systems, machine learning, and web-based projects.
                Proficient in Python, Scikit-Learn, ESP32 programming, VHDL, and modern web technologies.
                Actively seeking internship or entry-level opportunities to contribute to innovative engineering solutions.
              </p>
